...
import { GradeRequest } from '../../../../../shared/types/grades';
...
const newGradeRequest = (): GradeRequest => ({
  grade: 0, max: 0, comment: '', userId: 0, teacherId: 0, classroomHasCourseId: 0
});
